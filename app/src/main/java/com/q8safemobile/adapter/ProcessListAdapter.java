...
import com.q8safemobile.utils.Utils;
import com.squareup.picasso.Picasso;

import java.util.List;

import static com.q8safemobile.picasso.AppIconRequestHandler.SCHEME_PNAME;
...
public class ProcessListAdapter extends BaseAdapter {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      convertView = inflater.inflate(R.layout.item_protect_your_apps, parent, false);
    ...
    ImageView imageView = holder.find(R.id.appImage);
    TextView textView = holder.find(R.id.appTitle);
